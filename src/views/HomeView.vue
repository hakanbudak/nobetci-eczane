...
<template>
  <div class="h-[100dvh] w-full overflow-hidden bg-dark-900 flex flex-col">
    <!-- Header — her sayfada görünür (App.vue'dan buraya taşındı) -->
    <AppHeader
      :location-status="status"
      :pharmacy-count="pharmacies.length"
      :city-name="detectedCityName || selectedCitySlug"
    />
    <!-- Ana içerik -->
